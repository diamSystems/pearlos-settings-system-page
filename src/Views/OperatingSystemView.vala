...
public class About.OperatingSystemView : Gtk.Box {
    ...
    construct {
        ...
        var file_dark = File.new_for_path ("/usr/share/branding/logo.png");
        var file_light = File.new_for_path ("/usr/share/branding/logo_white.png");
        ...
        // Hardcoded OS name
        var pretty_name = "PearlOS, <b>by diam</b>";
